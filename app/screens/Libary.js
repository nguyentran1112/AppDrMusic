...
const {getHomeZing, home} = useContext(AppContext)
const {navigate, goBack} = navigation;
useEffect(()=> {
  fetch(
    `https://nhatthanh.online/api/getinfoplaylist?idlist='6BU9U9DC'`
  )
    .then((res) => res.json())
    .then((data) => {
...
// const test = home[3]?.items[0]?.album;
// console.log('Test data home', test)
  return (
